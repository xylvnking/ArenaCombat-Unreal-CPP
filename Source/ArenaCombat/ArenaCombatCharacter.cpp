...
void AArenaCombatCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AArenaCombatCharacter::SetCameraFOV(float NewFOV)
{
...
void AArenaCombatCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AArenaCombatCharacter::Move);
...
void AArenaCombatCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AArenaCombatCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
